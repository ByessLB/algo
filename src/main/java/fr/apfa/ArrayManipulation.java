...
public class ArrayManipulation {
    ...
    public static void sommeIndexInArray(Object... params) {
        ...
        try {
            i = (Integer) params[0];
            j = (Integer) params[1];
            // Intégration du tableau en param dans une variable si valide, sinon intégration du tableau par defaut
        ...
        // Intégration du tableau par defaut dans la variable dédié si le tableau en param est vide
        if(arrayClient.length == 0) {
            arrayClient = defaultArray;
        }

        // On vérifie si le premier param est propre à un indice du tableau entré en param
        if (i < 0 || i >= arrayClient.length) {
            System.out.println("Erreur ! L'indice i est invalide.");
            return;
        }

        // On vérifie si le second param est propre à un indice du tableau entré en param
    ...
    public static boolean swap(int paramA, int paramB, int[] array) {
        ...
        // En boucle pour identifier si les indices mis en param sont identifiable dans le tableau
    ...
    public static Integer calculMoyenne(int[] array) {
        ...
        // On fait la somme de notre résultat en fonction du nombre de valeurs de notre tableau
